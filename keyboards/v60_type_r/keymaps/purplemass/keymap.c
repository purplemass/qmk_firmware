...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_1_FUNCTION] = KEYMAP(
    ...
    // |          |░░░░░░░░|        |        |        |        |        |        |        |        |        |        |               |░░░░░░░░|
    // |          |░░░░░░░░|        |        |        |        |        |        |        |        | Page   |        | Page          |░░░░░░░░|
    // | Shift    |░░░░░░░░| BLMd-  | BLOFF  | BLMd+  |        | Vol-   | Vol+   | Mute   | End    | Down   | Down   | Up            |░░░░░░░░|
    // |--------------------------------------------------------------------------------------------------------------------------------------|
         _______,  XXXXX,    BL_INC,  BL_ON,   BL_DEC,  _______, KC_VOLD, KC_VOLU, KC_MUTE, KC_END,  KC_PGDN, KC_DOWN,  KC_PGUP,      XXXXX,  \
    // |--------------------------------------------------------------------------------------------------------------------------------------|
    // |          |          |          |                                                         |          |          |          |          |
    // |          |          |          |                                                         |          | Line     | Page     | Line     |
    // |          |          |          |                                                         |          | Start    | Down     | End      |
    // '--------------------------------------------------------------------------------------------------------------------------------------'
         _______,   _______,  TG_ARROWS,  _______,                                                 _______,    KC_HOME,   KC_PGDN,   KC_END),
    // '--------------------------------------------------------------------------------------------------------------------------------------'
